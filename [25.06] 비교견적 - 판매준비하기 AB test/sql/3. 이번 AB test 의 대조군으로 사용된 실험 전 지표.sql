...
SET start_date = '2025-04-14';                          -- 분석 시작일
SET end_date = '2025-05-11';                            -- 분석 종료일
...
SELECT
    ...
    COUNT(DISTINCT CASE WHEN EVENTTYPE = 'VIEW' AND SCREENNAME = '내차고_엔카홈' AND STATUS IN ('정보입력중', '차량저장') THEN PCID END) AS CNT_MYCAR_HOME_ING,
...
/* 
START_DATE	END_DATE	CNT_TOTAL_PCID	CNT_MYCAR_HOME	CNT_MYCAR_HOME_ING	CNT_REQUEST_ESTIMATE_CLICK1	CNT_REQUEST_ESTIMATE_CLICK2	CNT_ESTIMATE_COMPLETE	CNT_READY_TO_SELL_CLICK	CNT_READY_TO_SELL_VIEW	CNT_READY_TO_SELL_CONFIRM	CNT_PRICE_CONFIRM	CNT_PHOTO_CONFIRM	CNT_INFO_CONFIRM	CNT_ESTIMATE_CONFIRM
2025-04-14	2025-05-11	339590	93285	89215	36775	21006	8264	0	0	0	0	0	0	0
*/